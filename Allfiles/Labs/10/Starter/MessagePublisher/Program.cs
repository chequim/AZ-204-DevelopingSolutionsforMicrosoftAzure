 ...
 namespace MessagePublisher
 {
     public class Program
     {
         ...
         private const string serviceBusConnectionString = "Endpoint=sb://sbnamespacechequim.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=V/1iqd5taCHiWG7n6Vvg95TIF3AnhU29o+ASbBfWtcU=";
